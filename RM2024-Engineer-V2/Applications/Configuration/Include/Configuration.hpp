...
enum class EDeviceID {
  ...
  DEV_STRCH_MTR,          ///< Gantry Stretch Motor (M3508)
  DEV_TRAV_MTR,           ///< Gantry Traverse Motor (M2006)
  DEV_SUBLIFT_MTR_L,      ///< Sub-Gantry Lift Motor Left (M2006)
  DEV_SUBLIFT_MTR_R,      ///< Sub-Gantry Lift Motor Right (M2006)
  DEV_SUBSTRCH_MTR_L,     ///< Sub-Gantry Stretch Motor Left (M2006)
  DEV_SUBSTRCH_MTR_R,     ///< Sub-Gantry Stretch Motor Right (M2006)
  DEV_MANIP_MTR_YAW,      ///< Manipulator Motor Yaw (DM4310)
  DEV_MANIP_MTR_ROLL,     ///< Manipulator Motor Roll (DM4310)
...
enum class EModuleID {
  ...
  MOD_SUBGANTRY,      ///< Sub-Gantry Module
};
