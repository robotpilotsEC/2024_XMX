...
class CDevReferee final : public CDevInstance {
public:

  struct SDevRefereeInitParam : public SDevInitParam {
  ...
  CDevReferee() { deviceType = EDeviceType::DEV_REFEREE; }

  ERpStatus InitDevice(const SDevInitParam *pStruct) final;

  ERpStatus SendPackage(ECommandID commandID, SPkgHeader &packageHeader);
