 ...
 * @return
 */
void CSysReferee::UI_InitDrawing() {
 ...
 * @brief
 */
void CSysReferee::UI_StartCurModeTextDrawing_() {
  ...
  interface_->Transmit(reinterpret_cast<uint8_t *>(&curModeTextMsg), sizeof(curModeTextMsg));
}
 ...
 * @brief
 */
void CSysReferee::UI_StartStateFigureDrawing_() {
  ...
  interface_->Transmit(reinterpret_cast<uint8_t *>(&stateFigureMsg), sizeof(stateFigureMsg));
}
 ...
 * @brief
 */
void CSysReferee::UI_StartVisionFigureDrawing_() {
  ...
  interface_->Transmit(reinterpret_cast<uint8_t *>(&visionFigureMsg), sizeof(visionFigureMsg));
}
 ...
 * @brief
 */
void CSysReferee::UI_UpdateCurModeTextDrawing() {
 ...
 * @brief
 */
void CSysReferee::UI_UpdateStateFigureDrawing_() {

  static auto &gantry = *reinterpret_cast<CModGantry *>(ModuleMap.at(EModuleID::MOD_GANTRY));

  stateFigureMsg.message.figureConfig[0].operate = 2;
  stateFigureMsg.message.figureConfig[0].color = (gantry.gantryInfo.isPumpOn_C) ? 2 : 7;

  stateFigureMsg.message.figureConfig[1].operate = 2;
  stateFigureMsg.message.figureConfig[1].color = (gantry.gantryInfo.isPumpOn_L) ? 2 : 7;

  stateFigureMsg.message.figureConfig[2].operate = 2;
  stateFigureMsg.message.figureConfig[2].color = (gantry.gantryInfo.isPumpOn_R) ? 2 : 7;
 ...
 * @brief
 */
void CSysReferee::UI_UpdateVisionFigureDrawing_() {
  ...
  if (SysVision.systemState == RP_OK
      && SysVision.visionInfo.uiPoint.isFoundOreTank) {
 ...
 * @param arg
 */
void CSysReferee::StartSysRefereeUiTask(void *arg) {
  ...
  while (true) {
    ...
    SysReferee.UI_UpdateCurModeTextDrawing();
    proc_waitMs(100);
